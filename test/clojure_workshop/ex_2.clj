...
(fact "Filter removes values from a sequence"
      ...
      (filter #(> 0 %) (take 100 (iterate inc -5))) => [-5 -4 -3 -2 -1]
...
(fact "Java interop is pretty simple"
      ...
      (nth "a java string" 2) => \j

      ; Calling static methods is done with '/'. Format strings with the static format method (on java.lang.String).
      (java.lang.String/format "Calling Java methods using %s is not that %s" (into-array ["varargs" "cool"])) => "Calling Java methods using varargs is not that cool"
